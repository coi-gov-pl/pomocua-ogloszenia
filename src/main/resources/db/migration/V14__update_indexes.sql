...
CREATE index idx_material_aid_offer_city ON material_aid_offer (lower(city));
CREATE index idx_material_aid_offer_region ON material_aid_offer (lower(region));
...
CREATE index idx_accommodation_offer_city ON accommodation_offer (lower(city));
CREATE index idx_accommodation_offer_region ON accommodation_offer (lower(region));
...
CREATE index idx_transport_offer_origin_city ON transport_offer (lower(origin_city));
CREATE index idx_transport_offer_origin_region ON transport_offer (lower(origin_region));
CREATE index idx_transport_offer_destination_city ON transport_offer (lower(destination_city));
CREATE index idx_transport_offer_destination_region ON transport_offer (lower(destination_region));
