alter table accommodation_offer add column status text;
alter table transport_offer add column status text;
alter table material_aid_offer add column status text;
